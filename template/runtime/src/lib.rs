...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	authoring_version: 1,
	spec_version: 6,// Each time the Runtime is updated on the chain, the version number needs to be incremented.
	impl_version: 1,
...
pub const MILLISECS_PER_BLOCK: u64 = 6000;// milliseconds per block
...
pub const MAXIMUM_BLOCK_WEIGHT: Weight = 3 * WEIGHT_PER_SECOND;//2 * WEIGHT_PER_SECOND; // Adjusted to 3 seconds calculation time
...
parameter_types! {
	pub const Period: u32 = 10 * MINUTES;// Approximate time of each session
