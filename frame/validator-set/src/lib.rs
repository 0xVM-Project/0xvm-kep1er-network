...
pub mod pallet {
	...
	#[pallet::storage]
	#[pallet::getter(fn validators)]// The get function validators returns the local state Validators
...
impl<T: Config> pallet_session::SessionManager<T::AccountId> for Pallet<T> {
	...
	fn new_session(_new_index: u32) -> Option<Vec<T::AccountId>> {
		...
		Some(Self::validators())// Self=Pallet of this context. This Pallet has a get function validators() corresponding to the storage of Vaidators.
	}
